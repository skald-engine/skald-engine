...
class DeviceService extends Service {
  ...
  /**
   * Whether the browser supports sessionStorage or not. Notice that, some 
   * browsers that supports session storage, may disable it on incognito mode.
   * @type {Boolean}
   */
  ...
  _checkFeatures() {
    ...
    try {
      sessionStorage.setItem('asdfklajsdklfjajsdklf', 'meh');
      sessionStorage.removeItem('asdfklajsdklfjajsdklf');
      this._sessionStorage = true
    } catch(e) {}
